...
- un grafo (del griego /graphos/: dibujo o imagen) es un conjunto de objetos
  llamados vértives o nodos, unidos por enlaces llamados aristas o arcos.
- Permiten represnetar relaciones binarias entre elementos del conjunto de
  vertices
...
Los grafos nos permiten estudias las relaciones que existen entre unidades. Por
...
- Mediante conjuntos
*** Lista de nodos adyacentes
Como su nombre lo indica, se puede hacer la representación de un grafo a trvés
